	...
	public static void Init(Utilities.RobotType robotType)
	{
		switch (robotType) {
			case ROBOT_1:
				...
				instance.robotConstants.put("tumblerBackdrop", 820);
				...
				instance.robotConstants.put("liftLevel1", 600);
				instance.robotConstants.put("liftLevel2", 900);
				instance.robotConstants.put("liftLevel3", 1300);
